export function CarLogo({ className = '' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 48 24"
    ...
    >
      <path
        d="M4 16C6 12 10 10 16 10H32C38 10 42 12 44 16"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M8 16H40C42 16 44 17 44 19V20H4V19C4 17 6 16 8 16Z"
        fill="currentColor"
      />
      <circle cx="12" cy="20" r="3" fill="currentColor" />
      <circle cx="36" cy="20" r="3" fill="currentColor" />
      <path
        d="M18 10L22 6H30L34 10"
        stroke="currentColor"
        strokeWidth="1.5"
...
export function DownloadIcon({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 19 19" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M5.54199 7.91602L9.50033 11.8743L13.4587 7.91602"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function ShareIcon({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M6.44238 10.1323L11.5649 13.1173"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M11.5574 4.88232L6.44238 7.86732"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function CheckIcon({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 19 19" fill="none" aria-hidden="true">
      <path
        d="M15.8333 4.75L7.12496 13.4583L3.16663 9.5"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function ChartsIcon({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M6 18V10M12 18V6M18 18V13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  )
}
...
export function CertificateIcon({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 28 28" fill="none" aria-hidden="true">
      <path
        d="M15.1666 25.6667H21C21.6188 25.6667 22.2123 25.4208 22.6499 24.9832C23.0875 24.5457 23.3333 23.9522 23.3333 23.3333V9.33332C23.3342 8.96362 23.2619 8.59739 23.1205 8.25578C22.9791 7.91417 22.7715 7.60394 22.5096 7.34299L18.3236 3.15699C18.0627 2.89509 17.7524 2.68747 17.4108 2.5461C17.0692 2.40473 16.703 2.33241 16.3333 2.33332H6.99996C6.38112 2.33332 5.78763 2.57915 5.35004 3.01674C4.91246 3.45432 4.66663 4.04782 4.66663 4.66665V8.51665"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M16.3334 2.33331V8.16665C16.3334 8.47607 16.4563 8.77281 16.6751 8.9916C16.8939 9.2104 17.1906 9.33331 17.5 9.33331H23.3334"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M7 19.8333C8.933 19.8333 10.5 18.2663 10.5 16.3333C10.5 14.4003 8.933 12.8333 7 12.8333C5.067 12.8333 3.5 14.4003 3.5 16.3333C3.5 18.2663 5.067 19.8333 7 19.8333Z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"

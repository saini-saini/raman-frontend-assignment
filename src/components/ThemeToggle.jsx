...
export default function ThemeToggle({ className = '' }) {
  ...
  return (
    <button
      ...
      className={`relative z-50 cursor-pointer pointer-events-auto flex items-center justify-between w-[98px] h-[46px] p-[3px] rounded-full border border-black/15 dark:border-white/10 bg-[#3636364D] shadow-[0_2px_10px_rgba(0,0,0,0.06)] backdrop-blur-md transition-all duration-300 hover:scale-105 active:scale-95 hover:border-racing-red/40 ${className}`}
    >
      <span
